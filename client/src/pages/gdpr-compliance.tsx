      ...
      <section className="py-16 bg-muted/20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="glass-card " data-testid="card-consent-management">
              <CardHeader>
...
class ConsentManager {
  ...
  recordConsent(choices) {
    ...
    this.storeConsentRecord(consentRecord);
            ...
            <Card className="glass-card " data-testid="card-data-processing">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-3">
    ...
    switch (requestType) {
      ...
      case 'objection':
        return await this.stopProcessing(userId);
            ...
            <Card className="glass-card " data-testid="card-user-rights-automation">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-3">
...
class UserRightsAPI {
  ...
  async handlePortabilityRequest(userId) {
    ...
    return this.generateDownloadLink(structuredExport);
            ...
            <Card className="glass-card " data-testid="card-data-transfers">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-3">
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="glass-card text-center " data-testid="card-iso-27001">
            ...
            <Card className="glass-card text-center " data-testid="card-iso-27701">
              <CardContent className="pt-6">
                <Lock className="h-12 w-12 text-success mx-auto mb-4" />
            ...
            <Card className="glass-card text-center " data-testid="card-soc2-type2">
              <CardContent className="pt-6">
            ...
            <Card className="glass-card text-center " data-testid="card-gdpr-certified">
              <CardContent className="pt-6">
      ...
      <section className="py-16 bg-muted/20">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="glass-card " data-testid="card-privacy-dashboard">
              <CardHeader>
